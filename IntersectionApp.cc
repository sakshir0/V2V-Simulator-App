...
std::vector<IntersectMessage*> IntersectionApp::yieldToRight(std::vector<IntersectMessage*> vehicles) {
    /*
...
std::vector<IntersectMessage*> IntersectionApp::yieldToRightLeftTurns(std::vector<IntersectMessage*> vehicles) {
    /*
     * This function takes in a list of vehicle messages and figures out who has the right of way
     * based on the yield to right rule of an intersection. It is meant only for cars who are all
...
std::list<const char*> IntersectionApp::getVehicleIds(std::vector<IntersectMessage*> vehicles) {
    /*
...
std::list<const char*> IntersectionApp::priorityCars(std::vector<IntersectMessage*> vehicles) {
    /*
